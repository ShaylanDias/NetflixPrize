...
public class NetflixTester {
	...
	public static final String baseFile = "data" + FileIO.FILE_SEPARATOR + "1Ratings.csv";
	public static final String testFile = "data" + FileIO.FILE_SEPARATOR + "1Tests.csv";

	
	public static final String moviesFile = "data" + FileIO.FILE_SEPARATOR + "movies.csv";
	public static final String linksFile = "data" + FileIO.FILE_SEPARATOR + "links.csv";
	public static final String tagsFile = "data" + FileIO.FILE_SEPARATOR + "tags.csv";
	...
	public static void main(String[] args) {
		...
		
		{
			...
			ArrayList<String> baseDataLines = reader.read(baseFile);
		...
		ArrayList<String> testDataLines = reader.read(testFile);
