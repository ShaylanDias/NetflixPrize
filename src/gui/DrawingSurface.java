...
import testing.NetFlixPredictor;



public class DrawingSurface extends PApplet {

	public static final String ratingsFile = "ml-latest-small" + FileIO.FILE_SEPARATOR + "ratings.csv";
		...
		new Thread() {
			public void run() {
				predictor = new NetFlixPredictor(moviesFile,ratingsFile,tagsFile,linksFile);
				 ...
				 int ind = Collections.binarySearch(predictor.getMovies(), new Movie(recommendedID));
				 Movie m = predictor.getMovies().get(ind);
